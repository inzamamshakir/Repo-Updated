...
export function StatCard({ icon, title, value, counterSuffix }: StatCardProps) {
  return (
    <div className="group relative min-h-[155px] overflow-hidden rounded-5 bg-accent-100 p-30px dark:bg-accent-700">
      ...
      <h3 className="pr-20 font-secondary text-xl font-bold leading-[1.25] text-transparent [-webkit-text-fill-color:transparent] [-webkit-text-stroke:1px_#000933] dark:[-webkit-text-stroke:1px_white] md:text-2xl">
